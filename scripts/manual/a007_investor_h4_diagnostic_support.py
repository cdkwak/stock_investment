"""Frozen offline plan for the one-call Investor H4 availability diagnostic."""
...
from scripts.manual.a007_investor_h1_diagnostic_support import classify_availability_response
...
SCOPE_ID = "20160107_20180105_KOSPI_volume_H4_availability"
SCOPE = {"strtDd": "20160107", "endDd": "20180105", "inqCondTpCd": 1, "mktTpCd": 1}
EXPECTED_BUSINESS_DATA = {
    "bld": BUSINESS_BLD, "strtDd": SCOPE["strtDd"], "endDd": SCOPE["endDd"],
    "inqCondTpCd": "1", "mktTpCd": "1",
}
EXPECTED_DATE_COUNT = 490
EXPECTED_DATE_SHA256 = "c35bced36e8ea2715a7ced1ffce7d2c6d5ac9e0c5c399dfec57aa5a09b789c50"
CANONICAL_DATE_SOURCES = (
    ...
    },
    {
        ...
        "bytes": 449053,
        "sha256": "fad22bfd52c0513b4710d13470927cfc766589d6bce9fdb8c5494c795c30b7bd",
    },
    {
        "path": "data/published/kr_equity_canonical_universe_daily/market=KOSPI/year=2018/data.parquet",
        "bytes": 476203,
        "sha256": "dea1c15ac5014a4b66712d89d41e2537b6344dde79a7284be9b145b4c928f59f",
    },
)
...
def manifest_payload(*, run_id: str, created_at_utc: str, dates: tuple[str, ...]) -> dict[str, object]:
    ...
    return {
        ...
        "purpose": "diagnose_MDCSTAT30301_2016_2018_historical_availability",
...
def classify_response(body: bytes, dates: tuple[str, ...]):
    return classify_availability_response(
        body, dates, scope=SCOPE, full_range_classification="H4_FULL_RANGE_AVAILABLE",
    )
