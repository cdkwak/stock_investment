"""Exactly-one-call Landing-only Investor H2 availability diagnostic."""
...
LANDING_ROOT = ROOT / "data/landing/diagnostics/a007_investor_h2"
D_OWNED_LOCK_PATH = ROOT / "data/state/d_owned_krx_short_selling.lock"
CONFIRM_SCOPE = support.SCOPE_ID


def main() -> int:
    parser = argparse.ArgumentParser(description="One-call Landing-only Investor H2 diagnostic")
