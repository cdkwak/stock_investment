"""Exactly-one-call Landing-only Investor H1 availability diagnostic."""
...
from scripts.manual.diagnostic import a007_investor_h1_diagnostic_support as support
...
def main() -> int:
    parser = argparse.ArgumentParser(description="One-call Landing-only Investor H1 diagnostic")
