...
from scripts.manual.diagnostic import a007_investor_range_diagnostic_support as default_support
from scripts.manual.diagnostic.a007_investor_range_diagnostic_support import (
    BUSINESS_BLD,
