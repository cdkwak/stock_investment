"""Frozen offline plan for the one-call Investor H2 availability diagnostic."""
...
from scripts.manual.diagnostic.a007_investor_h1_diagnostic_support import (
    classify_availability_response,
)
...
SCOPE_ID = "20120105_20140103_KOSPI_volume_H2_availability"
SCOPE = {"strtDd": "20120105", "endDd": "20140103", "inqCondTpCd": 1, "mktTpCd": 1}
...
EXPECTED_DATE_SHA256 = "ed5e64f0fdf3fcb968462521f307c545f74b0cc00c006e618f9bc8a1c1931e9f"
CANONICAL_DATE_SOURCES = (
    ...
    {
        "path": "data/published/kr_equity_canonical_universe_daily/market=KOSPI/year=2013/data.parquet",
        "bytes": 384450,
        "sha256": "d831148614188edd4116bc20e6d06279f6f38852cdff32586f74a8b66d778dca",
    },
    {
...
def manifest_payload(*, run_id: str, created_at_utc: str, dates: tuple[str, ...]) -> dict[str, object]:
    ...
    return {
        ...
        "purpose": "diagnose_MDCSTAT30301_2012_2014_historical_availability",
...
def classify_response(body: bytes, dates: tuple[str, ...]):
    return classify_availability_response(
        body, dates, scope=SCOPE, full_range_classification="H2_FULL_RANGE_AVAILABLE",
    )
