"""Run only an eligible UR-221 USD/KRW 19:30 KST window."""
...
from stock_data.orchestration.naver_mobile_home_ur221_window import STATE_PATH, collector, selected_boundary
    ...
    if path.exists():
        try:
            ...
            valid = (
                ...
                and state.get("operation_id") == "UR-221"
...
def main() -> int:
    ...
    parser.add_argument("--confirm-ur221-window", action="store_true")
    args = parser.parse_args()
    if not args.confirm_ur221_window:
        parser.error("--confirm-ur221-window is required")
