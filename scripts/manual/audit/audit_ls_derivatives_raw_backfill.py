...
try:
    from scripts.manual.pilot.ls_derivatives_investor_pilot import atomic_json
    from scripts.manual.backfill.ls_derivatives_raw_backfill import scopes, validate_payload
