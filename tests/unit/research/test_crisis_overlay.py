...
def test_signal_normalisation_reuses_core_valuation_at_t_20_60() -> None:
    ...
    path, real_dates, signal_mark = aligned_core_path(
        asset, episode, equity, dates, offsets=(0, 20, 60),
    )
...
def test_overlay_json_shape_rounding_and_size_contract() -> None:
    ...
    payload = round_payload({
        ...
        "series": {episode_id: {"equity_reference": path}},
    ...
    assert payload["series"][episode_id]["equity_reference"][0] == 100.13
