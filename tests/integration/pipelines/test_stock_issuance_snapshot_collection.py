...
import scripts.manual.collect.collect_data_go_kr_stock_issuance_snapshot as module
from scripts.manual.pilot.data_go_kr_stock_issuance_pilot import CaptureSession, PilotError
...
def item(index, page):
    from scripts.manual.pilot.data_go_kr_stock_issuance_pilot import SOURCE_FIELDS
