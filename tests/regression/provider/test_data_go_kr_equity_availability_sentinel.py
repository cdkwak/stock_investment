...
from scripts.manual.diagnostic.data_go_kr_equity_availability_sentinel import (
...
def test_confirmation_is_required(tmp_path):
    ...
    script = Path(__file__).resolve().parents[3] / "scripts/manual/diagnostic/data_go_kr_equity_availability_sentinel.py"
