...
```powershell
.\.venv\Scripts\python.exe scripts\manual\diagnostic\diagnose_a007_investor_s1.py --acknowledge-cooldown-ended --confirm-one-live-request --confirm-landing-only --confirm-scope 20240807_20260807_KOSPI_volume_S1_diagnostic
```
...
```powershell
.\.venv\Scripts\python.exe scripts\manual\audit\verify_a007_investor_s1.py <run-dir> --project-root . --write-append-only-evidence
```
