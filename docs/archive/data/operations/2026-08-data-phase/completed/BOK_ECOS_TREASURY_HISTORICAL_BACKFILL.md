...
`docs/data/config/examples/bok_ecos_treasury_backfill.prepared.json`, bound to the retained
...
.\.venv\Scripts\python.exe .\scripts\manual\backfill_bok_ecos_treasury.py `
  --project-root . `
  --plan .\docs\data\config\examples\bok_ecos_treasury_backfill.prepared.json `
