...
The user supplied 28 official KRX CSV downloads in `docs/data/sources/krx/manual_inbox`. They were
...
- [Pre-2010 derivatives source decision](../../../../data/research/active/KRX_PRE2010_DERIVATIVES_SOURCE_DECISION.md)
