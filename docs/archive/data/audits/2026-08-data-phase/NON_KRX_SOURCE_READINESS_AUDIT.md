...
`docs/data/DATA_STATUS.md` for current status and
`docs/archive/data/handoffs/2026-08-data-phase/DATA_PHASE_HANDOFF_20260813.md` for the historical handoff; the
...
table below remains historical; use `data/DATA_STATUS.md` and provider runbooks for
current gates.
