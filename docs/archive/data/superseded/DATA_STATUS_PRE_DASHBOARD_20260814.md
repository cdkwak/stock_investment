...
> current coverage source; use [`docs/data/DATA_STATUS.md`](../../../data/DATA_STATUS.md).
...
- Toss market investor and Korean Treasury history use cursor pagination with
  ...
  official-source audit in `docs/archive/data/audits/2026-08-data-phase/A006_TREASURY_AVAILABILITY_AUDIT.md` confirms that
...
- Short-selling source feasibility is confirmed but its dataset contract/coverage
  ...
  require the post-A007 bounded pilot documented in `docs/archive/data/audits/2026-08-data-phase/VKOSPI200_SOURCE_AUDIT.md`.
  ...
  `docs/archive/data/audits/2026-08-data-phase/OFFICIAL_CREDIT_BALANCE_SOURCE_AUDIT.md` shows that its monetary FreeSIS
