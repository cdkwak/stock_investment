...
The retained snapshot file timestamp is **2026-08-13 22:07 KST**. This is the
snapshot date for routing displays; the deterministic report itself deliberately
...
not alter this immutable snapshot. Current registry and routing claims belong in
[Data Status](../../../../../data/DATA_STATUS.md), not in this inventory contract.
