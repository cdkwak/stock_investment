...
| Korean short selling | authenticated pykrx 1.2.8 | RUNNING; trading history has 3,094/9,174 completed scopes (1,547/4,587 dates), 3,019,177 rows through 2014-03-19; next bounded batch active | preserve the single authenticated stream; then collect balance and investor scopes sequentially |
...
- Short-selling source feasibility is confirmed but its dataset contract/coverage
  ...
  missing, or path-escaping evidence fails closed. A007 has completed 3,094 trading
  scopes and 3,019,177 production rows through 2014-03-19, with the next bounded
