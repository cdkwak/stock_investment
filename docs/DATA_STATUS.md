...
| Korean equity price/cap/universe | marcap + KRX Open API + FSC data.go.kr | complete, 1995-05-02..2026-08-10; price/cap 15,160,515 rows each, provider universe 14,935,989 rows | 2026-08-10 incremental used exactly two retry-free FSC calls (one shared price/cap response plus one listed-universe response); 2026-08-11 onward remains pending |
...
| Market breadth | canonical universe + Korean equity prices | DATA_COMPLETE, 15,415 rows, 1995-05-03..2026-08-10 | 2026-08-10 added two validated KOSPI/KOSDAQ rows after the retry-free official equity increment; prior frozen corrective evidence remains retained |
...
| 2020+ official equity | FSC stock price/listed APIs | complete, 2020-01-02..2026-08-10 | latest completed increment used Landing-first single-page calls and exact checkpoint reconciliation |
| `kr_equity_canonical_universe_daily` | listed-info + price union; master metadata | complete, 15,160,516 rows, 1995-05-02..2026-08-10 | 2,762 validated rows added for 2026-08-10; daily incremental for primary sources |
