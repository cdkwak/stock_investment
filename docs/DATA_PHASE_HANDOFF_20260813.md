...
The dated inventory under `data/state/audits` remains immutable historical
evidence. A new inventory v2 snapshot may be created only after all Data writers
are quiescent; it is not implied by this document.
