...
- The largest target-history gaps are KOSPI200 futures 1996-2009, options/PCR
  1997-2009, KOSPI200 futures/options investor statistics before and after their
  confirmed 1999-04-26 source start, canonical corporate actions,
  adjusted-price/total-return accounting, and the stopped short-selling Investor series.
...
| KOSPI200 futures investor net purchase | Normalized | Source-supported history | 1999-04-26..2026-08-13; 33,670 rows / 6,734 dates / 5 source categories; ALL session; trading value net purchase in 백만원 | DATA_COMPLETE | SOURCE_MAX_COMPLETE | USABLE_WITH_LIMITS | Maintain only from settings-bound official manual files; preserve exact source categories and rounding |
| KOSPI200 futures investor trading (broader target) | Normalized | 1996-05-present | No broader sell/buy/volume artifact; narrow net-purchase dataset is separate | NOT_IMPLEMENTED | TARGET_GAP | NOT_READY | Only pursue if the broader research use case requires sell/buy and volume dimensions |
| KOSPI200 options investor trading | Normalized | 1997-07-present | No artifact and no options files in the manual inbox | IMPLEMENTATION_READY | TARGET_GAP | NOT_READY | Obtain complete ALL/CALL/PUT and ALL/REGULAR/NIGHT manual exports with recorded units/settings |
...
| KB Securities daily market snapshots | Landing / Normalized | One provisional snapshot per trading day near 17:00 KST | Corrected pre-open run: OAuth 1 + IVSA0070 1, retry 0; raw PASS, but mixed slice dates (2026-08-12/13/14) invalidated common-date normalization | AUTH_FIXED | DATE_SEMANTICS_REVIEW_REQUIRED | NOT_READY | Raw run retained; 33 premature Normalized rows quarantined. Validate one post-close 17:00 snapshot before operational promotion |

## 4. Historical Coverage Gaps

| Priority | Dataset | Target | Actual | Missing | Source/Next Step |
|---:|---|---|---|---|---|
| 1 | KOSPI200 futures investor net purchase | Source-supported history | 1999-04-26..2026-08-13 complete for ALL-session trading-value net purchase | Pre-1999-04-26 has no meaningful `[15007]` rows and is not synthesized | Maintenance only; broader sell/buy/volume target remains independent |
| 2 | KOSPI200 options investor trading | 1997-07-present | No artifact; no options CSVs supplied | 1997-07-07..1999-04-25 unavailable on `[15007]`; all supported dimensions/files missing | **P1:** supply complete manual ALL/CALL/PUT × session × measure/side exports with settings evidence |
| 3 | KOSPI200 futures | 1996-present | 2010-01-04..2026-08-07 | 1996-2009 | Free official Basic Statistics is confirmed; obtain bulk/internal-use terms before collector work |
| 4 | KOSPI200 options | 1997-present | 2010-01-04..2026-08-07 | 1997-2009 | Free official Basic Statistics is confirmed; obtain bulk/internal-use terms before collector work |
| 5 | KOSPI200 PCR | 1997-present | 2010-01-04..2026-08-07 | 1997-2009 | Depends on historical options; deterministic rebuild afterward |
| 6 | Corporate actions | Broad history with canonical events | Dividend snapshot + 13 Rights observations + 152,676 issuance observations + one OpenDART combined paid/free success row | Canonical revision/event identity, broader action families, and PIT timing | Preserve source terms and receipts; do not equate filing versions with canonical events |
| 7 | Adjusted price / total return | 1995-present | Not implemented | All periods | Define accounting policy only after corporate-action evidence |
| 8 | Short-selling Investor | 2008-present | No accepted artifact | Full historical coverage/semantics | Access recovered; require official source evidence or a new semantic design before collection |
| 9 | Valuation | Historical PIT series | Bounded source probes only | Production history | Review a bounded authenticated KRX plan after access safety clears |
| 10 | Foreign ownership | Historical PIT series | Bounded source probes only | Production history | Deferred authenticated KRX pilot |
| 11 | ETF | Historical PIT series | Bounded source probes only | Production history | Deferred authenticated KRX pilot |
| 12 | VKOSPI | 2003-present where source supports | Source audit only | Production history | Resolve official/reproducible source and contract |
| 13 | Program trading | Historical market series | No accepted artifact | Production history | Resolve endpoint/request contract; do not use survivorship-unsafe per-symbol data |
| 14 | Yahoo/FRED provenance | Existing artifact coverage | Current artifacts complete; old responses absent | Lossless provenance for historical rows | Irrecoverable retrospectively; require Landing/ledger for future refreshes |
...
| KB daily snapshot | Seven provisional snapshot contracts | AUTH_FIXED / DATE_SEMANTICS_REVIEW_REQUIRED | Pre-open raw captured breadth 2, program 1, investor 6, liquidity 1, derivatives 3, domestic indices 8, global symbols 12; integrity PASS but date semantics blocked | Weekday 17:00 KST task registered; next run is raw comparison only | Preserve slice-specific dates; do not normalize or promote until the post-close comparison removes every ambiguity |
...
| Broader futures/options investor statistics | The dedicated futures net-purchase dataset is complete, but it intentionally has no sell/buy, volume, option-right, or non-ALL session dimensions | Treat broader datasets as separate future targets; never derive missing dimensions or synthesize the 1996/1997-1999 gap | [Investor-statistics audit](../data/audits/KRX_DERIVATIVES_INVESTOR_STATS_AUDIT.md), [deferred runbook](../runbooks/deferred/KRX_DERIVATIVES_INVESTOR_COLLECTION.md) |
