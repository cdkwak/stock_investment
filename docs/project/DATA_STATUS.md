...
| KOSPI200 futures investor trading | Normalized | 1996-05-present | No artifact; contract/collector ready; source first meaningful row 1999-04-26 | IMPLEMENTATION_READY | TARGET_GAP | NOT_READY | **P1:** explicit KRX automated-collection permission, then one retry-zero bounded pilot; full pre-2010 scope 108 calls |
| KOSPI200 options investor trading | Normalized | 1997-07-present | No artifact; contract/collector ready; source first meaningful row 1999-04-26 | IMPLEMENTATION_READY | TARGET_GAP | NOT_READY | **P1:** explicit permission, then bounded pilot; full pre-2010 session/right scope 324 calls |
...
|---:|---|---|---|---|---|
| 1 | KOSPI200 futures investor trading | 1996-05-present | No artifact; source rows confirmed from 1999-04-26 | 1996-05-06..1999-04-25 is unavailable on `[15007]`; all supported history remains uncollected | **P1:** explicit KRX automation permission, then one-call pilot; full pre-2010 scope 108 calls |
| 2 | KOSPI200 options investor trading | 1997-07-present | No artifact; source rows confirmed from 1999-04-26 | 1997-07-07..1999-04-25 is unavailable on `[15007]`; all supported history remains uncollected | **P1:** explicit permission, then one-call pilot; full pre-2010 scope 324 calls |
...
| Derivatives investor statistics | Futures / options investor trading | IMPLEMENTATION_READY / PERMISSION_GATE | Contracts, validation, 432-call complete plan, Landing/ledger/checkpoint/resume, and one-call pilot are implemented offline | No active stream | Retained explicit KRX automated-collection permission evidence; tool fails before transport without it |
...
| Futures/options investor statistics | Source begins materially on 1999-04-26; taxonomy semantics remain source-native; complete scope costs 432 requests; KRX terms prohibit unauthorized automation | Obtain explicit KRX permission evidence, then run only the one-call retry-zero pilot; never synthesize the 1996/1997-1999 gap | [Investor-statistics audit](../data/audits/KRX_DERIVATIVES_INVESTOR_STATS_AUDIT.md), [deferred runbook](../runbooks/deferred/KRX_DERIVATIVES_INVESTOR_COLLECTION.md) |
