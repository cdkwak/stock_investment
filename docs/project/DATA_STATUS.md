...
| KOSPI200 futures investor trading | Normalized | 1996-05-present | No target artifact; 28 manual official CSVs retained in Landing cover one unresolved-unit/session net series, 6,734 dates, 1999-04-26..2026-08-13 | PARTIAL_SOURCE_EVIDENCE | TARGET_GAP | NOT_READY | Obtain the missing sell/buy and volume/value exports plus explicit session/unit settings; do not infer them from values |
...
|---:|---|---|---|---|---|
| 1 | KOSPI200 futures investor trading | 1996-05-present | One manual net-series evidence set retained, 1999-04-26..2026-08-13; target artifact not built | 1996-05-06..1999-04-25 unavailable on `[15007]`; sell/buy, both measures, verified session/unit settings missing | **P1:** complete the manual source bundle with settings evidence; existing 28 files remain immutable evidence |
...
| Derivatives investor statistics | Futures / options investor trading | PARTIAL_MANUAL_SOURCE_RETAINED / TARGETS_NOT_BUILT | 28 user-provided futures net-series CSVs copied hash-exact to immutable Landing; 6,753 physical rows, 6,734 unique dates, 19 identical boundary overlaps | No active stream; zero calls for import | Complete manual exports and retain source settings; network collector remains separately permission-gated |
...
| Futures/options investor statistics | Manual inbox contains only one futures net series; CSVs do not encode measure, unit, or session; options are absent | Supply the remaining official manual exports with a settings manifest; never synthesize the 1996/1997-1999 gap or infer missing dimensions | [Investor-statistics audit](../data/audits/KRX_DERIVATIVES_INVESTOR_STATS_AUDIT.md), [deferred runbook](../runbooks/deferred/KRX_DERIVATIVES_INVESTOR_COLLECTION.md) |
