...
if len(CONTRACTS) != 24 + len(DATA_V1_CONTRACTS) + len(KR_DERIVATIVE_CONTRACTS) + len(KBSEC_SNAPSHOT_CONTRACTS) + len(LEGACY_KOSPI200_CONTRACTS) + len(LEGACY_MARKET_INVESTOR_CONTRACTS) + len(INVESTOR_BRIDGE_CONTRACTS) + len(DIVIDEND_OBSERVATION_CONTRACTS) + len(KOSPI200_DERIVATIVES_BRIDGE_CONTRACTS) + len(TOSSINVEST_HISTORICAL_CONTRACTS) + len(BOK_ECOS_TREASURY_CONTRACTS) + len(STOCK_ISSUANCE_OBSERVATION_CONTRACTS) + len(KRX_DERIVATIVES_INVESTOR_CONTRACTS) + len(LS_T8428_CONTRACTS) + len(KOSPI200_CONSTITUENT_BREADTH_CONTRACTS) + len(KR_ETF_CONTRACTS):
