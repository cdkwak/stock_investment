...
KR_MARKET_DAILY_V6_SLOT_LANES = {
    **KR_MARKET_DAILY_V5_SLOT_LANES,
    "20:30": (
        "CANONICAL_EQUITY_DAILY", "KR_ETF_PRICE_DAILY",
        "KOSPI200_BREADTH_DAILY", "SHORT_SELLING_DAILY",
        "SHORT_SELLING_BALANCE_DAILY", "SHORT_SELLING_INVESTOR_DAILY",
        "LENDING_DAILY", "VKOSPI_DAILY", "KR_INDEX_DAILY",
        "DERIVATIVES_PRICE_DAILY", "MARKET_INVESTOR_DAILY",
        "LIQUIDITY_CREDIT_DAILY", "LS_T8462_DAILY", "TOSS_KR_TREASURY_DAILY",
    ),
}
KR_MARKET_DAILY_SLOT_LANES = {
    **KR_MARKET_DAILY_V6_SLOT_LANES,
    "20:30": (
        ...
        "KR_ETF_PRICE_DAILY", "KOSPI200_BREADTH_DAILY",
        "SHORT_SELLING_DAILY", "SHORT_SELLING_BALANCE_DAILY",
        "SHORT_SELLING_INVESTOR_DAILY", "LENDING_DAILY", "VKOSPI_DAILY",
        "KR_INDEX_DAILY", "DERIVATIVES_PRICE_DAILY", "MARKET_INVESTOR_DAILY",
        "LIQUIDITY_CREDIT_DAILY", "LS_T8462_DAILY", "TOSS_KR_TREASURY_DAILY",
...
def _expected_kr_market_daily_lanes(
    ...
    if payload.get("lane_contract_version") == KR_MARKET_DAILY_LANE_CONTRACT_VERSION:
        return current
    if payload.get("lane_contract_version") == 6:
        return KR_MARKET_DAILY_V6_SLOT_LANES[slot]
    if payload.get("lane_contract_version") == 5:
        return KR_MARKET_DAILY_V5_SLOT_LANES[slot]
    if (
