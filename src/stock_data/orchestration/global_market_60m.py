...
CURRENT_UNITS = {
    ...
    "SP500_FUTURES_CURRENT_60M": "index points",
    "DOW_FUTURES_CURRENT_60M": "index points",
    "SOX_CURRENT_60M": "index points",
    "DOLLAR_INDEX_CURRENT_60M": "index points",
...
_SESSION_TRACE_RULES = {
    ...
    "SP500_FUTURES_CURRENT_60M": ("FUTURES_PROVIDER_SESSION", "18:00", None),
    "DOW_FUTURES_CURRENT_60M": ("FUTURES_PROVIDER_SESSION", "18:00", None),
    "SOX_CURRENT_60M": ("CASH_REGULAR", "09:30", "16:00"),
    "DOLLAR_INDEX_CURRENT_60M": ("FUTURES_PROVIDER_SESSION", "18:00", None),
