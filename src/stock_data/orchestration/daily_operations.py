...
DAILY_LANE_READINESS = (
    ...
    LaneReadiness("KR_ETF_INVESTOR_FLOW_DAILY", LaneReadinessStatus.READY,
        ...
        "watchlist investor summaries; descriptive only and predictive PIT blocked", True, None,
        "first live run 2026-09-05 17:25 COMPLETE (10 calls, 80 rows, latest XKRX session 09-04); "
        "Windows task STOCK_DATA_KR_ETF_INVESTOR_FLOW_DAILY weekdays 16:20 KST"),
