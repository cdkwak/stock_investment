...
DAILY_LANE_READINESS = (
    ...
    LaneReadiness("GLOBAL_INDEX_DAILY", LaneReadinessStatus.READY,
        ...
        "confirmed three-symbol CAS promotion and exact-session pre-network no-op",
        "global-index Dashboard health adapter", True, None,
        "schedule registered SP500/NASDAQ_COMPOSITE/NASDAQ100 only after session close"),
    ...
    LaneReadiness("GLOBAL_ETF_DAILY", LaneReadinessStatus.READY,
        ...
        "confirmed CAS promotion and exact-session pre-network no-op", "SOXX dashboard health adapter", True,
        None, "schedule the explicitly registered SOXX symbol only"),
    LaneReadiness("GLOBAL_COMMODITY_DAILY", LaneReadinessStatus.READY,
        ...
        "confirmed three-symbol CAS promotion, forming-session exclusion, and exact-session pre-network no-op",
        "NQ/Gold/WTI dashboard health adapter", True, None,
        "schedule only NQ=F, GC=F, and CL=F after the provider finality window; descriptive daily bars only"),
