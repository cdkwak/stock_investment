...
GLOBAL60M_UR232_CURRENT_SPECS = {
    ...
    "SP500_FUTURES_CURRENT_60M": ("CME", "ES=F", "index points", "S&P 500 continuous futures"),
    "DOW_FUTURES_CURRENT_60M": ("CBOT", "YM=F", "index points", "Dow continuous futures"),
    "SOX_CURRENT_60M": ("XNAS", "^SOX", "index points", "Philadelphia Semiconductor index"),
    "DOLLAR_INDEX_CURRENT_60M": ("ICE", "DX-Y.NYB", "index points", "ICE U.S. Dollar Index"),
